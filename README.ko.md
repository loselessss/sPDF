...
- 무손실·균형·강한 압축 중에서 선택해 PDF 용량 줄이기
- 왼쪽 패널을 없음 → 페이지 미리보기 → 책갈피 순서로 전환
- PDF 안의 문서 이동 및 웹 링크를 Ctrl+클릭으로 열기
...
- [x] **v1.14.0 PDF 최적화·탐색** — 무손실·균형·강한 압축으로 용량을 줄이고, 왼쪽 패널을 없음·페이지 미리보기·책갈피로 전환하며, 문서 및 웹 링크를 Ctrl+클릭으로 안전하게 열기
- [x] **v1.14.1 언어·발표 화면 개선** — 설치 언어를 최초 UI에 반영하고 시작 화면은 PDF를 중심으로 표시하며, 업데이트 언어를 일치시키고 프레젠테이션 방향키 이동과 텍스트 표시 왼쪽 패널 리본 메뉴 적용
